...
volatile int base_proj_point;
volatile int tilt_proj_point;

uint8_t projected_points[6] = {0};
uint8_t start_char = 0x00;
uint8_t bool_started = 0x00;

PID_TypeDef basePID;
PID_TypeDef tiltPID;

double posIn1, posIn2, spOut1, spOut2, goal1, goal2;
/* USER CODE END PV */
